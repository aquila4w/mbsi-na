/*
  ...
  The original seed used guessable IDs like a0000001-0000-0000-0000-000000000001.
  This migration reassigns all seeded rows to random UUIDs.

  Order matters: update child tables before parent tables due to FK constraints.
*/

-- Mapping of old → new UUIDs for student_metrics_students
-- (27 students: IDs 001–027)

-- Step 1: Temporarily disable FK checks by updating child tables first

-- advancement_decisions (references student_metrics_students)
...
-- student_year_profiles (references student_metrics_students)
...
-- student_place_assignments (references student_metrics_students)
...
-- student_enrollments (references student_metrics_students)
...
-- student_metrics_records (references student_metrics_students)
...
-- Step 2: Now update the parent table (student_metrics_students)
...
-- Step 3: Update the advancement session ID
